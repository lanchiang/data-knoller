...
//
//		Set<MetadataOld> targetMetadata = createTargetMetadataManually();
//
...
//
//
//	private static Set<MetadataOld> createTargetMetadataManually() {
//		Set<MetadataOld> targetMetadata = new HashSet<>();
...
//	}
//	private static Set<MetadataOld> createTargetMetadataManuallyBenke() {
//		Set<MetadataOld> targetMetadata = new HashSet<>();
//		targetMetadata.add(new PreambleExistence(false));
