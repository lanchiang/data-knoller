...
import de.hpi.isg.dataprep.preparators.define.ChangeFileEncoding
...
class DefaultChangeFileEncodingImpl extends PreparatorImpl {
    ...
    override def executePreparator(preparator: AbstractPreparator, dataFrame: DataFrame): Consequences = {
