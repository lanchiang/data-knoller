package de.hpi.isg.dataprep.model.objects.system;
...
public interface AbstractPipeline extends Nameable {
    ...
    /**
     * Configure the {@link de.hpi.isg.dataprep.model.objects.metadata.Metadata} prerequisites used when checking metadata, as well as
